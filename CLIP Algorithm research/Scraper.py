...
search_term_dog = ['dog','dog in house','small dog','big dog','furry dog','cute dog','happy dog',
                   'sitting dog','dancing dog','good dog']
...
#     search_and_download(search_term=search_terms,driver_path=DRIVER_PATH,number_images = 50
#     )
